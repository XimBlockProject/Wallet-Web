    ...
    public partial class CoinService
    {
        ...
        public class CoinParameters
        {
                ...
                short rpcRequestTimeoutInSeconds)
            {
                ...
                else if (coinService is XimBlockService)
                {
                    if (!IgnoreConfigFiles)
                    {
                        DaemonUrl = ConfigurationManager.AppSettings.Get("XimBlock_DaemonUrl");
                        DaemonUrlTestnet = ConfigurationManager.AppSettings.Get("XimBlock_DaemonUrl_Testnet");
                        RpcUsername = ConfigurationManager.AppSettings.Get("XimBlock_RpcUsername");
                        RpcPassword = ConfigurationManager.AppSettings.Get("XimBlock_RpcPassword");
                        WalletPassword = ConfigurationManager.AppSettings.Get("XimBlock_WalletPassword");
                    }
                    CoinShortName = "XIM";
                    CoinLongName = "XimBlock";
                    IsoCurrencyCode = "XIM";
